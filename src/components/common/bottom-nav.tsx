      ...
      <nav className="flex h-16 items-center justify-around px-1">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              {item.isCreate ? (
                 <div className="absolute -top-4 left-1/2 -translate-x-1/2 flex h-12 w-12 items-center justify-center rounded-full bg-background text-white shadow-lg ring-2 ring-teal-600 transition-transform hover:scale-105">
